...
<div>
  <div class="container">
    ...
    <form method="POST">
      <c:if test="${!empty requestScope.updateError}">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="photo"  value="${car.photo}"/>
      </div>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="capacity"  value="${car.capacity}"/>
  </div>
  <div class="form-group">
    <button type="submit" class="btn btn-primary"><fmt:message key="submit.button"/></button>
  </div>
</div>
</form>
</body>
